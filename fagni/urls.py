...
urlpatterns = [
    ...
    path("api/routine/essai/<str:order_code>/", api_routine_essai_detail, name="routine-essai-detail"),
    ...
    path("api/ops/orders/<int:order_id>/confirm-declared-wave/", ops_confirm_declared_wave, name="api-ops-confirm-declared-wave"),
