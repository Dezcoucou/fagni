...
urlpatterns = [
    ...
    # DESACTIVE - en attente resolution support PythonAnywhere (deploiement non fiable) path("api/parrainage/creer/", api_creer_parrainage_v2secure, name="parrainage-creer"),
    # DESACTIVE - en attente resolution support PythonAnywhere (deploiement non fiable) path("api/parrainage/valider/", api_valider_code_parrainage, name="parrainage-valider"),
    # DESACTIVE - en attente resolution support PythonAnywhere (deploiement non fiable) path("api/parrainage/stats/<str:parrain_type>/<int:parrain_id>/", api_stats_parrainage, name="parrainage-stats"),
