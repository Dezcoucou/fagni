...
urlpatterns = [
    ...
    # DESACTIVE TEMPORAIREMENT (audit sécurité en cours) path("api/parrainage/creer/", api_creer_parrainage, name="parrainage-creer"),
    # DESACTIVE TEMPORAIREMENT (audit sécurité en cours) path("api/parrainage/valider/", api_valider_code_parrainage, name="parrainage-valider"),
    # DESACTIVE TEMPORAIREMENT (audit sécurité en cours) path("api/parrainage/stats/<str:parrain_type>/<int:parrain_id>/", api_stats_parrainage, name="parrainage-stats"),
