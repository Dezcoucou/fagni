...
def ops_dashboard(request):
    ...
    for o in qs[:100]:
        ...
        orders.append({
            ...
            'payment_verification_status': o.payment_verification_status,
            'payment_declared_at': o.payment_declared_at.isoformat() if o.payment_declared_at else None,
            'payment_declared_channel': o.payment_declared_channel or '',
            'payment_declared_reference': o.payment_declared_reference or '',
